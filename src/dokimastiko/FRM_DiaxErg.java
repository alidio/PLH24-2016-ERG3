 ...
 * @author Dionysis
 */
public class FRM_DiaxErg extends javax.swing.JFrame {
    
    List<Employee> EmployeeList;
    
    /**
     * Creates new form FRM_DiaxErg
     */
    public FRM_DiaxErg() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRM_DiaxErg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRM_DiaxErg().setVisible(true);
            }
        });
    }
